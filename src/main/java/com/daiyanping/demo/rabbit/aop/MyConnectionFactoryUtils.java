...
public class MyConnectionFactoryUtils {

    private MyConnectionFactoryUtils() {
        super();
    }
    ...
    public static RabbitResourceHolder getTransactionalResourceHolder(final ConnectionFactory connectionFactory,
        ...
        return doGetTransactionalResourceHolder(connectionFactory, new MyConnectionFactoryUtils.RabbitResourceFactory(connectionFactory,
    ...
    private static RabbitResourceHolder doGetTransactionalResourceHolder(// NOSONAR complexity
                                                                         ConnectionFactory connectionFactory, ConnectionFactoryUtils.ResourceFactory resourceFactory) {
...
//        }
        ...
        if (TransactionSynchronizationManager.isSynchronizationActive()) {
            TransactionSynchronizationManager.registerSynchronization(new MyConnectionFactoryUtils.RabbitResourceSynchronization(resourceHolder,
                    connectionFactory));
        }
        return resourceHolder;
    }
    ...
    private static class RabbitResourceFactory implements ConnectionFactoryUtils.ResourceFactory {
